            ...
            {reasons.map((reason, index) => (
              ...
              >
                <div className="relative z-10">
                  <div aria-hidden="true" className="text-5xl">{reason.icon}</div>
                ...
                <div aria-hidden="true" className="absolute -bottom-4 -right-4 text-8xl opacity-5 transition-transform duration-300 group-hover:scale-110">
                  {reason.icon}
                </div>
              </div>
            ))}
